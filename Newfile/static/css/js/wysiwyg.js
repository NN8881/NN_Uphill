    ...
    */
    ...
    var wysiwyg = function (option) {
        ...
        if (option_element != null) {
            is_textarea = option_element.nodeName == 'TEXTAREA' || option_element.nodeName == 'INPUT';
        }
        if (is_textarea) {
        ...
        if (is_textarea) {
            ...
            node_textarea.className = node_textarea.className + " hide";
        ...
        // If not read-only
        if (!option_readonly && node_wysiwyg != null)
